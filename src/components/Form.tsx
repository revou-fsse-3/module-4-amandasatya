...
import { Card, Button, Title, ProgressBar, Icon } from "./index";
  ...
  return (
    <>
      <div className="flex justify-center items-center">
        <div className="h-82 w-72 ">
          <div className="flex flex-col justify-center items-center">
            <Title className="">{"Welcome To The Register Page"}</Title>
            <Title>{"Or Register Via"}</Title>
          </div>
          <Icon />
